...
def extend_cfg(cfg):
    ...
    cfg.TRAINER.CSDG.GATE.BIAS_TARGET = None
    cfg.TRAINER.CSDG.GATE.BIAS_TARGET_EPOCH = None
    ...
    cfg.TRAINER.CSDG.LOSS.GATE_ENT_WEIGHT_TARGET = None
    cfg.TRAINER.CSDG.LOSS.GATE_ENT_WEIGHT_TARGET_EPOCH = None
